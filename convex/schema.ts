...
export default defineSchema({
  ...
  lobbyMembers: defineTable({ lobbyId: v.id("lobbies"), userId: v.id("users"), username: v.string(), ready: v.boolean(), connected: v.boolean(), order: v.number(), joinedAt: v.number() }).index("by_lobby", ["lobbyId"]).index("by_lobby_user", ["lobbyId", "userId"]),
